      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#hero" className="text-2xl font-sans font-bold text-white tracking-tight">
              NG<span className="text-secondary">III</span>
            </a>
            <p className="mt-2">Entrepreneur & Software Engineer</p>
          </div>
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {currentYear} Nick Gattuso III. All rights reserved.</p>
